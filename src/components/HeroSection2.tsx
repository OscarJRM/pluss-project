      ...
      >
        {slides.map((slide, index) => (
          ...
          >
            ...
            {/* Text Content */}
            <div className="relative z-10 text-white px-4 sm:px-6 lg:px-8 drop-shadow-lg">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 drop-shadow-2xl">
                {slide.heading}
              </h1>
             <p className="text-lg sm:text-xl md:text-2xl mb-6 max-w-3xl mx-auto text-white drop-shadow-2xl"> 
                {slide.text}
              </p>
            </div>
          </div>
